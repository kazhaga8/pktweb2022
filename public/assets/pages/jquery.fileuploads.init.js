...
$(document).ready(function () {
    ...
    $(".fileupload").each(function () {
        var varextensions = $(this).attr("extensions");
        var maxFileSize = $(this).attr("maxFileSize");
        var maxFile = $(this).attr("maxFile");
        var multiple = $(this).attr("multiple");

        varextensions = (typeof varextensions != 'undefined' ? varextensions.split("|") : null);
        maxFileSize = (typeof maxFileSize != 'undefined' ? maxFileSize : null);
        maxFile = (typeof maxFile != 'undefined' ? maxFile : null);
        multiple = (typeof multiple != 'undefined' ? true : false);
        console.log(varextensions);

        $(this).filer({
            limit: maxFile,
            maxSize: maxFileSize,
            extensions: varextensions,
            changeInput: true,
            showThumbs: true,
            addMore: multiple,
            captions: {
