...
<head>
  ...
  <title>{{ isset($page) ? $page->title : 'COMING SOON' }} {{ isset($page) ? $page->meta_title : '' }} | {{ config('app.meta_title') ? config('app.meta_title') : 'PT Pupuk Kaltim' }}</title>
  <meta content="{{ isset($page) && $page->meta_desc != '' ? $page->meta_desc : config('app.meta_desc') }}" name="description">
  <meta content="{{ isset($page) && $page->meta_keyword != '' ? $page->meta_keyword : config('app.meta_keyword') }}" name="keywords">
