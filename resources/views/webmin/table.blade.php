                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="btn-toolbar">
                            <button type="button" class="btn btn-rounded btn-icons waves-effect waves-inverse "><i class="fa fa-trash"></i></button>
                            <button type="button" class="btn btn-rounded btn-icons waves-effect waves-inverse "><i class="fa fa-refresh"></i></button>
                            <button type="button" class="btn btn-rounded btn-icons waves-effect waves-inverse "><i class="fa fa-plus"></i></button>
        ...
        $(document).ready(function() {
            $('#datatable').dataTable({
                ...
                dom: "<'row col-md-12' <'col-sm-2 col-md-6'l> <'col-sm-2 col-md-6'f> >" +
                    // "<'row col-md-12' <'col-sm-2 col-md-6'> <'col-sm-2 col-md-6'> >" +
            ...
            //     ajax: "{{ url('public') }}/plugins/datatables/json/scroller-demo.json",
            //     deferRender: true,
            //     scrollY: 380,
            //     scrollCollapse: true,
            //     scroller: true
